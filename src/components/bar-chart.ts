...
export class AccordionBarChart extends LitElement {
  ...
  constructor() {
    ...
    this.chartOption = {      
      ...
      colors: this.type === `HTTP` ? [`rgba(61, 134, 73, 0.9)`, 'rgba(114, 188, 245, 0.9)', `rgba(241, 171, 33, 0.9)`, `rgba(201, 24, 12, 0.9)`] : [`rgba(61, 134, 73, 0.9)`, `rgba(201, 24, 12, 0.9)`],
      series: this.type === `HTTP` 
      ? [
        {
          name: '2xx',
          data: [this.data[0]]
